...
/* harmony export */   "Anchors": function() { return /* binding */ anchors; },
...
function glideSlide() {
  ...
  function addSmoke(id) {
    slideItems.forEach(li => {
      ...
      img.classList.remove('show'); // img.style = '';
    });
    slideItems[id].classList.remove('smoke');
    slideItems[id].querySelector('.caption').classList.add('show');
    slideItems[id].querySelector('.prize').classList.add('show'); // if(slideItems[id-1] && slideItems[id+1]) {
